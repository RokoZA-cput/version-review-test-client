 ...
 * @author Heinrich
 */
public class UICodeView extends JFrame implements TreeSelectionListener {
    ...
    private void initComponents() {
        ...
        textAreaOutput = new javax.swing.JEditorPane();
                ...
                if(task.getTaskClassList().size() > 0) {
                    ...
                    for(TaskClass taskClass : task.getTaskClassList()) {
                        ...
                        if(taskClass.getUserFinalFiles().containsKey(user)) {
                            ...
                            highlighter.getHighlighter().addMouseListener(new UICodeView.HighlightLineListener(highlighter.getHighlighter(), finalFile));
        ...
        public void mousePressed(MouseEvent e) {
            ...
            for(FileChange change : changeList) {
                if(change.getMarkerType() == FileChange.MARKER_HIGHLIGHT || change.getMarkerType() == FileChange.MARKER_UNDERLINE) {
                    if(line >= change.getClassMember().getStartLine() && line <= change.getClassMember().getEndLine()) {
                        print(change.getUser().getUsername() + " - " + change.getType() + " this " + change.getClassMember().getType() +".");
                    }
                }
                else if(change.getMarkerType() == FileChange.MARKER_NEW_FILE) {
                    if(line == change.getClassMember().getStartLine()) {
                        print(change.getUser().getUsername() + " " + change.getType() + " this " + change.getClassMember().getType() +".");
                    }
                }
            }
